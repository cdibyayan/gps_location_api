                ...
                <div class="card shadow border-0 mb-7">
                    <div class="card-header">
                        ...
                        <div class="col-sm-6 col-12 text-sm-end">
                            <div class="mx-n1">
                                <button type="button" class="btn d-inline-flex btn-sm btn-primary mx-1" data-toggle="modal" data-target="#myModal">
                                <span class=" pe-2">
                                        <i class="bi bi-plus"></i>
                                    </span>
                                    <span>Create</span>
                                </button>
                                <!-- <a class="btn d-inline-flex btn-sm btn-primary mx-1" data-toggle="modal" data-target="#myModal">
                                    <span class=" pe-2">
                                        <i class="bi bi-plus"></i>
                                    </span>
                                    <span>Create</span>
