...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="sidebarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="zone-tracking.php">
    ...
    include "db.php"; 
    $id=$_GET['id'];
    $select = "SELECT * FROM gps_data WHERE `id`='$id'";
        ...
        <main class="py-6 bg-surface-secondary">
            <div class="container-fluid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="uid" value="<?php echo $row['uid'] ?>" name="uid">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="zone" value="<?php echo $row['last_zone'] ?>" name="zone">
                </div>
                <div class="form-group">
                    <label for="uid">last Updated Location:</label>
                    <input type="text" class="form-control" id="uid" value="<?php echo $row['last_loc'] ?>" name="location">
                </div>
                <div class="form-group">
